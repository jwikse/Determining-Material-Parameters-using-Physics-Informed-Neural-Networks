...
def stress(x, y):
    ...
    E = 1.35e-1  # True is 0.135 N/mum^2
...
plt.title("Ex1 Const E: nu vs Epochs")
plt.grid(True)
plt.tight_layout()
...
plt.title("Ex1 Const E: Training Loss vs Epochs")
plt.grid(True)
plt.tight_layout()
plt.savefig("...../......./.png", dpi=150)
plt.close()
