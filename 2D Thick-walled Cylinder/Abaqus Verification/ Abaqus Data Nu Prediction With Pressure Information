...
# Coords are in mm, displacements are in mm. Pressure is in MPa, E is in MPa.
...
def output_transform(x, y):
    ...
    # Enforce radial traction transform only
...
plt.title("Ex1 Const E Abaqus Data: nu vs Epochs")
plt.grid(True)
plt.tight_layout()
...
plt.title("Ex1 Const E Abaqus Data: Training Loss vs Epochs")
plt.grid(True)
plt.tight_layout()
plt.savefig("....../....../.png", dpi=150)
plt.close()
